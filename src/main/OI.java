...
public class OI extends ImprovedClass {	
	public OI() {
		...
		xbox2.leftBumper.whenPressed(new ArmToggle());
		xbox2.rightBumper.whenPressed(new ToggleTilt());
