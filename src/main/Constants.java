...
public interface Constants {
	...
	//0.0025 0.03 is the recommended value and we could use a tiny bit more correction
    public static double straightDriveKp = 0.03;
	// ELEVATOR LENGTHS 
	...
	public final double minimumDriveThrottle = 0.25;//Needs to be modified
	...
	public final double driveTrainDistanceTolerance = 0.1;
	...
	public final double minimumTurnThrottle = 0.1;//Needs to be modified
